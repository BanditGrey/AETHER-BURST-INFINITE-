...
- [x] **Painel Equipar estilo tela de jogo** (referência do usuário) — coluna de runners com estrelas/poder, retrato central c/ sprite + aura, 8 slots brilhando (4 de cada lado; vazio = silhueta da peça), PODER em destaque, grid de stats que preenche o centro, ícones de elemento/passiva/skill/burst, inventário em grade de ícones **com arte recortada** c/ tooltip no hover, equip em 1 clique, painel sempre contido na tela (sem rolagem geral) e **bag que rola com roda ou arraste**
